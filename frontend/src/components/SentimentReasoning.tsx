...
export default function SentimentReasoning({ articles, ticker }: SentimentReasoningProps) {
  ...
  return (
    <div className="glass-card animate-fade-in-up" style={{ padding: "24px 28px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "18px", flexWrap: "wrap", gap: "10px" }}>
        ...
        <div style={{ display: "flex", gap: "6px" }}>
          <span style={{
            ...
            color: "#34d399", borderRadius: "6px", padding: "3px 10px", fontSize: "0.72rem", fontWeight: 700,
          }}>
            ▲ ポジ {positiveCount}件
          </span>
          <span style={{
            background: "rgba(244,63,94,0.1)", border: "1px solid rgba(244,63,94,0.3)",
            color: "#f43f5e", borderRadius: "6px", padding: "3px 10px", fontSize: "0.72rem", fontWeight: 700,
          }}>
            ▼ ネガ {negativeCount}件
          </span>
          {neutralCount > 0 && (
            <span style={{
              ...
              color: "#fbbf24", borderRadius: "6px", padding: "3px 10px", fontSize: "0.72rem", fontWeight: 700,
            }}>
              ━ 中立 {neutralCount}件
            </span>
          )}
      ...
      <div style={{
        height: "1px",
        background: "linear-gradient(90deg, transparent, rgba(56,189,248,0.25), rgba(52,211,153,0.15), transparent)",
        marginBottom: "18px",
      }} />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: "999px",
              boxShadow: `0 0 6px ${cfg.barColor}`,
