...
const BULLISH_KEYWORDS = [
  ...
  "Profit Increase", "Bullish Breakout", "強い", "堅調",
];
...
function highlightText(text: string): React.ReactNode[] {
  ...
  return parts.map((part, i) => {
    ...
    if (kw.type === "bullish")
      return (
        <span key={i} className="neon-badge" style={{ margin: "0 2px" }}>
          {part}
        </span>
      );
    if (kw.type === "bearish")
      return (
        <span key={i} className="neon-badge-red" style={{ margin: "0 2px" }}>
          {part}
        </span>
      );
    return (
    ...
    >
      ...
      <div
        style={{
          height: "1px",
          background:
            "linear-gradient(90deg, transparent, rgba(56,189,248,0.3), rgba(52,211,153,0.2), transparent)",
          marginBottom: "20px",
        }}
      />
      ...
      >
        ...
        >
          ...
          >
            gemini-pro-analyst :: {ticker} :: 分析完了
          </span>
        </div>
